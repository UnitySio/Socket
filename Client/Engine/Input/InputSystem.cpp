...
bool InputSystem::Keyboard::PollEvents(KeyEvnet& event)
{
...
bool InputSystem::Keyboard::GetKeyState(WORD key_code)
{
    return key_states_[key_code];
}

bool InputSystem::Keyboard::ProcessMessage(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam, MathTypes::uint32 handler_result)
{

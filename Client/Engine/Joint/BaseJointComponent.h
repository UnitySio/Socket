...
public:
	...
	void CreateJointDefWithTarget(std::shared_ptr<Actor> target, const bool& flag = true);
...
template<typename T, typename U>
inline void BaseJointComponent<T, U>::CreateJointDefWithTarget(std::shared_ptr<Actor> target, const bool& flag)
{
